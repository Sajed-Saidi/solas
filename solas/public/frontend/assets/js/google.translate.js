...
*/
        ...
        _.Ra = function (a, b) {
            ...
            var c, d;
            b =
                (d = (c = "document" in b ? b.document : b).querySelector) ==
                null
                    ? void 0
                    : d.call(c, a + "[nonce]");
        ...
        w = function (a, b) {
            if (b)
                a: {
                    ...
                    b != d &&
                        b != null &&
                        pb(c, a, { configurable: !0, writable: !0, value: b });
                }
        };
        w("Symbol", function (a) {
            if (a) return a;
        ...
        _.y = function (a) {
            ...
            if (typeof a.length == "number") return { next: ob(a) };
        ...
        _.Ba = function (a) {
            return (
                (Object.prototype.hasOwnProperty.call(a, Pb) && a[Pb]) ||
                (a[Pb] = ++Qb)
            );
        };
        ...
        _.Zb = Array.prototype.lastIndexOf
            ? function (a, b) {
        ...
        _.qc = function () {
            return (
                ...
                Math.abs(
                    Math.floor(Math.random() * 2147483648) ^ _.Ub()
                ).toString(36)
            );
        };
        var rc = !!(Kb[0] & 1024),
        ...
        _.Cc =
            _.v("Gecko") &&
            !(_.Wa().toLowerCase().indexOf("webkit") != -1 && !_.v("Edge")) &&
        ...
        hd = function (a, b, c, d) {
            function e(h) {
                h &&
                    b.appendChild(
                        typeof h === "string" ? a.createTextNode(h) : h
                    );
            }
            for (; d < c.length; d++) {
                var f = c[d];
        ...
        _.rd.prototype.zf = function (a, b) {
            ...
            d
                ...
                : ((this.offsetX =
                      _.Dc || a.offsetX !== void 0 ? a.offsetX : a.layerX),
                  (this.offsetY =
                      _.Dc || a.offsetY !== void 0 ? a.offsetY : a.layerY),
        ...
        xd.prototype.add = function (a, b, c, d, e) {
            ...
            g > -1
                ? ((b = a[g]), c || (b.Kd = !1))
                : ((b = new vd(b, this.src, f, !!d, e)), (b.Kd = c), a.push(b));
            return b;
        };
        ...
        _.Nd = function (a) {
            ...
            Dd--;
            (c = _.Hd(b))
                ? (zd(c, a), c.h == 0 && ((c.src = null), (b[Bd] = null)))
                : wd(a);
            return !0;
        };
        Kd = function (a) {
        ...
        _.k.dispatchEvent = function (a) {
            ...
            if (b)
                for (f = 0; !a.jd && f < b.length; f++)
                    (g = a.currentTarget = b[f]), (e = Pd(g, d, !1, a) && e);
            return e;
        };
        _.k.I = function () {
            _.G.O.I.call(this);
        ...
        _.ie.prototype.then = function (a, b, c) {
            return me(
                this,
                Zd(typeof a === "function" ? a : null),
                Zd(typeof b === "function" ? b : null),
                c
            );
        };
...
*/
        ...
        var Ie = function (a) {
            ...
            Ae = function (a) {
                ...
                d &&
                    ((h = (0, _.A)(a.G, a, !0)),
                    (d = (0, _.A)(a.G, a, !1)),
                    b instanceof xe ? (De(b, h, d), (b.K = !0)) : b.then(h, d));
        ...
        Nb.Ta = Le;
        Nb.Ta.g = { vg: 0, kg: 1, TIMEOUT: 2, tg: 3, Je: 4 };
        var Ne = function () {
            Yd.call(this);
            this.P = null;
            this.g = {};
        ...
        var Se = function (a) {
            ...
            Pe = function (a, b, c) {
                a.g[b]
                    ? ((a = a.g[b].h),
                      a != c &&
                          a.splice.apply(a, [0, a.length].concat(_.Ab(c))))
                    : (a.g[b] = new Vd(c, b));
            },
            Ve = function (a, b, c) {
                var d = [];
                ...
                for (var e = {}, f = 0; f < d.length; f++) {
                    ...
                    h.g
                        ? l.callback(a.Ca)
                        : (Te(a, g, h, !!c, l), Ue(a, g) || b.push(g));
                }
                b.length > 0 &&
                    (a.l.length === 0 ? a.M(b) : (a.h.push(b), Se(a)));
                return e;
            },
            Te = function (a, b, c, d, e) {
            ...
            if (e.length !== 0) {
                ...
                a = (0, _.A)(this.B.G, this.B, _.ya(e), this.g, {
                    ...
                    Jf: function (f, g) {
                        ...
                        f == 401
                            ? (Xe(d, new Nb.Ta(Nb.Ta.g.vg, f)),
                              (d.h.length = 0))
                            : f == 410
                            ? (Ye(d, new Nb.Ta(Nb.Ta.g.tg, f)), Ze(d))
                            : d.D >= 3
                            ? (Ye(d, new Nb.Ta(Nb.Ta.g.kg, f, l, g)), Ze(d))
                            : d.M(d.o, !0, f == 8001 || !1);
                    },
        ...
        var We = function (a, b) {
            ...
            Qe = function (a) {
                a.j == a.F &&
                    ((a.j = null),
                    a.F.onLoad((0, _.A)(a.Ug, a)) &&
                        Xe(a, new Nb.Ta(Nb.Ta.g.Je)),
                    Se(a));
            },
            ma = function (a) {
                if (a.j) {
        ...
        Ne.prototype.Sh = function (a) {
            this.j ||
                ((this.g.synthetic_module_overhead = new Vd(
                    [],
        ...
        _.ef = { done: !0, value: void 0 };
        _.df.prototype.Fb = function () {
            return this;
        };
        var jf = function (a) {
                if (a instanceof ff || a instanceof gf || a instanceof hf)
                    return a;
                if (typeof a.next == "function")
                    return new ff(function () {
                        return a;
                    });
        ...
        _.kf.prototype.delete = function (a) {
            return mf(this.h, a)
                ? (delete this.h[a],
                  --this.size,
                  this.j++,
                  this.g.length > 2 * this.size && lf(this),
                  !0)
                : !1;
        };
        var lf = function (a) {
        ...
        _.Mf.prototype.fa = function (a, b) {
            ...
            this.h(
                null,
                "function" == typeof _.Nf && a instanceof _.Nf ? a.Vb : null
            );
            return String(a);
        };
        ...
        Vf.prototype.toString = function () {
            if (this.h.endsWith("_/wa/"))
                var a = this.h + Wf(this, "wk") + this.l;
        ...
        var Yf = function (a) {
            ...
            fg = function (a) {
                ...
                if (d.h.endsWith("_/r/"))
                    return Zf(d, "sc", eg(a).toString()), d;
                if (!b) return d;
                (b = c.match(_.Ef)[6] || null) &&
                    _.Gf(b, function (h, l) {
                        d.j[h] = l;
                    });
                return d;
            ...
            cg = function (a) {
                ...
                d !== -1
                    ? (b = a.slice(c, d))
                    : Object.values(dg).forEach(function (e) {
        ...
        _.rg.prototype.send = function (a, b, c, d) {
            ...
            try {
                this.l && (clearTimeout(this.l), (this.l = null)),
                    this.B > 0 &&
                        (this.l = setTimeout(this.U.bind(this), this.B)),
                    (this.A = !0),
                    this.g.send(a),
                    (this.A = !1);
            } catch (g) {
        ...
        _.zg = function (a) {
            ...
            if (!c) {
                if ((b = b === 0))
                    (a = String(a.s).match(_.Ef)[1] || null),
                        !a &&
                            _.t.self &&
                            _.t.self.location &&
        ...
        wf({
            ...
            initialize: function (a) {
                ...
                !e &&
                    ...
                    ((e = f.src ? f.src : f.getAttribute("href")), (e = Og(e)));
                e || (e = Og(Ug));
                e ||
                    ((e = document.getElementsByTagName("script")),
                    (e = Og(e[e.length - 1].src)));
                if (!e) throw Error("$");
                e = new Dg(e);
                c && (e.o = c);
                d && (e.l = d);
...
(function () {
    ...
    (function () {
        ...
        c._ps =
            "https://www.gstatic.com/_/translate_http/_/ss/k\x3dtranslate_http.tr.26tY-h6gH9w.L.W.O/am\x3dDAY/d\x3d0/rs\x3dAN8SPfrCcgxoBri2FVMQptvuOBiOsolgBw/m\x3del_main_css";
        c._plla = oph + "/v1/supportedLanguages";
        c._puh = "translate.google.com";
        c._cnal = {};
        _loadCss(c._ps);
        _loadJs(
            "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.en_US.KNTRWfMnI_M.O/am\x3dACA/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfqzvsW2KLEj6yi5uUTl6GNx6SZwyw/m\x3del_main"
        );
        _exportMessages();
