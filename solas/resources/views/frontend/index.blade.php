        ...
        <section id="activity" class="details section">
            ...
            <div class="container">
                <div class="d-flex justify-content-center align-items-center">
                    <div class="row gy-4 align-items-center features-item contentLinker">
                        ...
                        <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
                            ...
                            @if (isset($activity->id))
                                <a href="{{ route('contents.show', $activity->id) }}" class="read-more mt-1"><span>Learn
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div class="row gy-4 align-items-center features-item contentLinker">
                        ...
                        <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
                            ...
                            @if (isset($activity->id))
                                <a href="{{ route('contents.show', $article->id) }}" class="read-more mt-1"><span>Learn
                                        More</span><i class="bi bi-arrow-right"></i></a>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4">
                        ...
                        <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3>Call Us</h3>
                                <p translate="no">{{ $settings->phone }}</p>
                            </div>
                        </div>
                        <!-- End Info Item -->
                        ...
                        <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div>
                                <h3>Email Us</h3>
                                <p translate="no">{{ $settings->email }}</p>
                            </div>
                        </div>
                        <!-- End Info Item -->
                    </div>
